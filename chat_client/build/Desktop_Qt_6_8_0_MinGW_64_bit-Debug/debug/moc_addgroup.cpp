...
struct qt_meta_stringdata_CLASSAddGroupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAddGroupENDCLASS = QtMocHelpers::stringData(
    "AddGroup",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAddGroupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AddGroup::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAddGroupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAddGroupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddGroupENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AddGroup, std::true_type>,
...
void *AddGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAddGroupENDCLASS.stringdata0))
