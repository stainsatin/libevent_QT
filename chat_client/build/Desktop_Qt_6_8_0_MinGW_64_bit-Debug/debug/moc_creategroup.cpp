...
struct qt_meta_stringdata_CLASSCreateGroupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCreateGroupENDCLASS = QtMocHelpers::stringData(
    "CreateGroup",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCreateGroupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CreateGroup::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCreateGroupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCreateGroupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCreateGroupENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CreateGroup, std::true_type>,
...
void *CreateGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCreateGroupENDCLASS.stringdata0))
